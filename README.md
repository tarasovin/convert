...
[`elvish`](https://github.com/elves/elvish)
 ...
 `docker run --rm -it --name "convert" -v "${PWD}":/x/files tarasov/convert`
...
xls-to-csv - Преобразует все файлы xls в csv в текущем каталоге. Первым параметром может быть задана маска поиска файлов в текущем каталоге (без подкаталогов) для преобразования. По умолчанию маска равна "*.xls"
...
xlsx-to-csv - Преобразует все файлы xlsx в csv в текущем каталоге. Первым параметром может быть задана маска поиска файлов в текущем каталоге (без подкаталогов) для преобразования. По умолчанию маска равна "*.xlsx"
